...
def preprocessing(batch):
    ...
    logging.info("aaaaaaaaaaaaaaaaaaaaaaah")
...
TestSetup = Testing(clients, start_servers=True, clear_logs=True, data_source='0',clear_db=False, interface=False)
operator = Operator()
